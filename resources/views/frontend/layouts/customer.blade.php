        ...
        <div class="row">
            <div class="col-12 col-lg-4">
                <div class="customize__box">
                    <div class="customize__box-image animate__animated animate__fadeInLeft wow"><img src="{{BASE_URL}}Frontend/assets/images/home/customize-1.jpg" alt=""></div>
                    <div class="customize__box-item animate__animated animate__zoomIn wow" data-wow-delay="0.5s">
                        ...
                        <p class="item__text">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna.</p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-lg-4">
                <div class="customize__box">
                    <div class="customize__box-image animate__animated animate__fadeInUp wow" data-wow-delay="1s"><img src="{{BASE_URL}}Frontend/assets/images/home/customize-2.jpg" alt=""></div>
            ...
            <div class="col-12 col-lg-4">
                <div class="customize__box">
                    <div class="customize__box-image animate__animated animate__fadeInRight wow" data-wow-delay="2s"><img src="{{BASE_URL}}Frontend/assets/images/home/customize-3.jpg" alt=""></div>
