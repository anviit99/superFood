    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-8 mx-auto text-center animate__animated animate__zoomIn wow" data-wow-delay="0.5s">
                ...
                <p class="title__text">We support environmental awareness, just business practices, and health, and our selections illustrate that.</p>
            </div>
        </div>
        <div class="row">
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 line">
                <div class="history__box animate__animated animate__fadeInUp wow" data-wow-delay="1s">
                    ...
                    <p class="history__box-text">Ropefish knifefish stickleback Manta Ray, saw shark drum; rohu deepwater stingray</p>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 line">
                <div class="history__box animate__animated animate__fadeInUp wow" data-wow-delay="1s">
