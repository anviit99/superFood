...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <form action="/small/public/admin/roles/update/{{$roles->id}}" method="POST">
            <div class="role__content row">
                <div class="col-md-4">
                    <div class="role__left">
                        <div class="form-group">
                            <label for="roleNameUpdate">Tên quyền:</label>
                            <input type="text" name="roleNameUpdate" class="form-control" id="roleNameUpdate" value="{{$roles->name}}">
                        </div>
                        <button type="submit"
