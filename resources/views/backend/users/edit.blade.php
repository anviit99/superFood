...
@section('content')
    ...
    <div style="width: 40%; margin: auto">
        <form action="/small/public/user/update/{{$user['id']}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input  type="text" name="name" class="form-control" id="userFirstNameUpdate" value="{{$user['name']}}">
    </div>


    <div class="form-group">
        <label for="userEmailUpdate">Email:</label>
        <input  type="text" name="email" class="form-control" id="userEmailUpdate" value="{{$user['email']}}">
    </div>
    <div class="form-group">
        <label for="userPasswordUpdate">Mật khẩu:</label>
        <input type="password" name="password" class="form-control" id="userPasswordUpdate" value="{{$user['password']}}">
    </div>
    <div class="form-group">
        <label for="userRepasswordUpdate">Nhập lại mật khẩu:</label>
        <input type="password" name="password" class="form-control" id="userRepasswordUpdate" value="{{$user['password']}}" >
    </div>
    <div class="form-group">
